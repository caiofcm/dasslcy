 ...
 *     print('res={} and py_calc_res[0]={}'.format(res[0], py_calc_res[0]))             # <<<<<<<<<<<<<<
 * 
 *     #PAREI AQUI-> O ponteiro do py_calc_res se perde, pois res  criado no py e depois morre
 */
  ...
  /* "dasslc.pyx":61
 *     #PAREI AQUI-> O ponteiro do py_calc_res se perde, pois res  criado no py e depois morre
 *     # Ver como  feito nas funces do dasslc em puro c para evitar a multipla definicao do res
 *     ires = 0             # <<<<<<<<<<<<<<
 *     return ires
 * 
 */
...
static PyObject *__pyx_pw_6dasslc_3call_res(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("call_res (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_residual_function)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tf)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("call_res", 1, 2, 2, 1); __PYX_ERR(0, 64, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "call_res") < 0)) __PYX_ERR(0, 64, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("call_res", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 64, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_PyFloat_AsDouble(__pyx_v_tf); if (unlikely((__pyx_t_1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_f_6dasslc_eval_residual_function(((void *)__pyx_v_residual_function), __pyx_t_1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_t_3 = PyFloat_FromDouble((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_tspan.data + __pyx_t_1 * __pyx_v_tspan.strides[0]) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __pyx_t_3 = PyFloat_FromDouble((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_tspan.data + __pyx_t_4 * __pyx_v_tspan.strides[0]) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_y0, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_float64_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_float64_t, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_size); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_t_5); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *     cdef int index[1]
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_kp_s_neq, __pyx_n_s_format); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_neq); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = NULL;
  ...
  if (!__pyx_t_7) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 76, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    #if CYTHON_FAST_PYCALL
    ...
    #endif
    {
      ...
      __pyx_t_6 = 0;
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_8, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 76, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    }
  }
 ...
 *     return
 */
    if (__Pyx_PrintOne(0, __pyx_kp_s_Setup_error_here) < 0) __PYX_ERR(0, 83, __pyx_L1_error)
 ...
 */
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tspan)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("solve", 0, 3, 7, 1); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("solve", 0, 3, 7, 2); __PYX_ERR(0, 67, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "solve") < 0)) __PYX_ERR(0, 67, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_tspan = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[1]); if (unlikely(!__pyx_v_tspan.memview)) __PYX_ERR(0, 67, __pyx_L3_error)
    __pyx_v_y0 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[2]); if (unlikely(!__pyx_v_y0.memview)) __PYX_ERR(0, 67, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_yp0 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[3]); if (unlikely(!__pyx_v_yp0.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("solve", 0, 3, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 67, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("dasslc.solve", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_6dasslc_4solve(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_resfun, __Pyx_memviewslice __pyx_v_tspan, __Pyx_memviewslice __pyx_v_y0, __Pyx_memviewslice __pyx_v_yp0, PyObject *__pyx_v_rpar, PyObject *__pyx_v_rtol, PyObject *__pyx_v_atol) {
  ...
  __Pyx_RefNannySetupContext("solve", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_tspan.memview)) { __Pyx_RaiseUnboundLocalError("tspan"); __PYX_ERR(0, 67, __pyx_L1_error) }
  if (unlikely(!__pyx_v_y0.memview)) { __Pyx_RaiseUnboundLocalError("y0"); __PYX_ERR(0, 67, __pyx_L1_error) }
  if (unlikely(!__pyx_v_yp0.memview)) { __Pyx_RaiseUnboundLocalError("yp0"); __PYX_ERR(0, 67, __pyx_L1_error) }
  __pyx_t_2.__pyx_n = 4;
  __pyx_t_2.yp0 = __pyx_v_yp0;
  __pyx_t_2.rpar = __pyx_v_rpar;
  __pyx_t_2.rtol = __pyx_v_rtol;
  __pyx_t_2.atol = __pyx_v_atol;
  __pyx_t_1 = __pyx_f_6dasslc_solve(__pyx_v_resfun, __pyx_v_tspan, __pyx_v_y0, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 * 
 */
  __pyx_tuple__30 = PyTuple_Pack(2, __pyx_n_s_residual_function, __pyx_n_s_tf); if (unlikely(!__pyx_tuple__30)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__30);
  __Pyx_GIVEREF(__pyx_tuple__30);
  __pyx_codeobj__31 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__30, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dasslc_pyx, __pyx_n_s_call_res, 64, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__31)) __PYX_ERR(0, 64, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6dasslc_3call_res, NULL, __pyx_n_s_dasslc); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_call_res, __pyx_t_1) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __pyx_k_ = __pyx_t_3;
